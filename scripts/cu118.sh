...
mamba run -n cu118 pip install --root-user-action ignore torch-geometric==2.4.0 einops==0.8.1 lightning==2.5.5 torchmetrics==1.8.2 numpy==1.26.4 PySocks==1.7.1
